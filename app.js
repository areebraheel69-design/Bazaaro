...
document.querySelector('#checkoutBtn').onclick=()=>alert(cart.length?'Checkout is ready for your Pakistan COD flow. Connect your payment/order backend next.':'Your cart is empty.');
